...
print(paste0("Started 4-USDA_Evaluation_CAR_Problem_TX at ", Sys.time()))
...
# Minnesota
load("0-Data/Shapefiles/contigW-TX.Rda")
STdata <- subset(data, STATE == "TX" & !(zip %in% c(c(77982, 78597))))
