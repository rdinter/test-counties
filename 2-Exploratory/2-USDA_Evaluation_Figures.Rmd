...
This time period is typically described as the diffusion of broadband, which follows the S-curve that most other technologies are familiar with. We can partially observe this by looking at the proportion of zip codes with broadband access over this time instead of the number of providers:

```{r Zip Uptake}
<<Zip Uptake>>
```

In one sense, these zip codes can be described as broadband adopters although this particular measure is of availability and not necessarily use of broadband.
